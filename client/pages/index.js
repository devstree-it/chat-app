...
const Home = () => {
  ...
  const loginUser = async (e) => {
    ...
    try {
      console.log("asdasds", process.env.NEXT_PUBLIC_BACKENDURL);
  ...
  return (
    <ColorChange>
      <NextSeo
        ...
        description="Login in to the Devstree Chat App to start messaging to others"
      />
      <Flex
        color={color}
        bgColor={bg}
      ...
      >
        {/* <HeaderMeta
        content={"Login in to the Devstree Chat App to start messaging to others"}
        title={"Login for the Devstree Chat App"}
      /> */}
        <Stack
          flexDir="column"
          mb="2"
