...
const Register = () => {
  ...
  return (
    <ColorChange>
      {" "}
      <NextSeo
        description={"Register to create the account in Devstree Chat App"}
      ...
      >
        {/* <HeaderMeta
          content={"Register to create the account in Devstree Chat App"}
          title={"Register to Devstree Chat App"}
        /> */}
        <Stack
          flexDir="column"
          mb="2"
