...
const OTP = () => {
  ...
  return (
    <ColorChange>
      {" "}
      <NextSeo
        description={"OTP to activate the account in Devstree Chat App"}
      ...
      >
        {/* <HeaderMeta
        content={"OTP to activate the account in Devstree Chat App"}
        title={"OTP for the Devstree Chat App"}
      /> */}
        <Stack
          flexDir="column"
          mb="2"
